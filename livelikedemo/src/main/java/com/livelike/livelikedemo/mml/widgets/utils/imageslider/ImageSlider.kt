package com.livelike.livelikedemo.mml.widgets.utils.imageslider
...
internal class ImageSlider @JvmOverloads constructor(
    ...
    var imageSliderTheme: ImageSliderTheme? = null
        set(value) {
            field = value
            val bgColor = getColorFromString(value?.body?.background?.color)
            bgColor?.let {
                colorTrack = bgColor
            }
        }
    ...
    init {
        ...
        trackDrawable.setTrackHeight(dpToPx(5).toFloat())
        ...
        if (attrs != null) {
            ...
            try {
                ...
                resultGradientCenterColor = array.getColor(
                    ...
                    ContextCompat.getColor(
                        context,
                        R.color.image_slider_widget_result_center_color
                    )
                )
                resultGradientEndColor = array.getColor(
                    R.styleable.ImageSlider_bar_result_color_end,
                    ContextCompat.getColor(
                        context, R.color.image_slider_widget_result_end_color
                    )
                )
            ...
            colorStart = ContextCompat.getColor(
                context, R.color.image_slider_gradient_start
            )
            colorEnd = ContextCompat.getColor(
                context, R.color.image_slider_gradient_end
            )
            colorTrack = ContextCompat.getColor(
                context, R.color.image_slider_bg
            )
            resultGradientCenterColor =
                ContextCompat.getColor(
                    context, R.color.image_slider_widget_result_center_color
                )
