package com.livelike.livelikedemo.mml.timeline
...
class TimeLineWidgetFactory(val context: Context, private val widgetList : List<WidgetsTimeLineView.TimelineWidgetResource>) : LiveLikeWidgetViewFactory {
