...
internal interface WidgetDataClient {
    suspend fun voteAsync(widgetVotingUrl: String, voteId: String?=null, accessToken: String?=null, body: RequestBody? = null, voteCount: Int=0, ispatch: Boolean=false, ispost: Boolean=false):String?
